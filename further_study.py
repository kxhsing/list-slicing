...
def custom_append(input_list, value):
    ...
    input_list[num_items:num_items+1] = [value]
...
def custom_extend(input_list, second_list):
    ...
    input_list[num_items:num_items+1] = second_list
...
def custom_insert(input_list, index, value):
    ...
    second_list = []
    second_list[0:1] = [value]
    second_list[1:] = input_list[index:]

    input_list[index:] = second_list
...
def custom_reverse(input_list):
    ...
    for i in range(num_items):    
        input_list[i] = reverse_list[num_items - i - 1]
...
def custom_equality(some_list, another_list):
    ...
    if num_items_some != num_items_another:
        return False

    for i in range(num_items_some):
